...
//		accountService.transferFunds("4253892", "1263862", 100, "payment of invoice 10232");
		...
		// the lambda expression doesn't work unless the command has only one method in the interface because its
		// has to be functional interface for even working at the first place
		remoteControl.setCommands(0, ()-> accountService.deposit("1263862", 240));
		remoteControl.setCommands(1, ()-> accountService.deposit("1263862", 529));
		remoteControl.setCommands(2, ()-> accountService.withdraw("1263862", 230));
...
//		remoteControl.setCommands(4, transferFundCommand2);
		remoteControl.setCommands(3, ()-> accountService.deposit("4253892", 12450));
		remoteControl.setCommands(4, ()-> accountService.transferFunds("4253892", "1263862", 100, "payment of invoice 10232"));
